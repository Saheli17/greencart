...
// const Cart = () => {
//     const { setcartItems, user, axios, products, cartItems, navigate, currency, getCartCount, getCartAmount, updateCartItem, removeFromCart } = useAppContext()
...
//                 <button onClick={placeOrder} className="w-full py-3 mt-6 cursor-pointer bg-primary text-white font-medium hover:bg-primaryDull transition">
                        ...
                        <AnimatePresence>
                            {showAddress && (
                                <motion.div
                                    ...
                                    className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-50"
                                >
                                    {addresses.map((address) => (
                                        <p
                                            key={address._id}
