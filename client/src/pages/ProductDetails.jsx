...
//                             Add to Cart
//                         </button>
//                         <button onClick={() => { addToCart(product._id); navigate("/cart") }} className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primaryDull transition" >
//                             Buy now
//                         </button>
//                     </div>
//                 </div>
                ...
                >
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        ...
                        <motion.button
                            ...
                            className="w-full py-3.5 cursor-pointer font-medium bg-primary text-white hover:bg-primaryDull transition"
                        >
                            Buy now
                        </motion.button>
                    </div>
