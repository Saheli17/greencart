...
//                     <p className='flex justify-between mb:items-center text-gray-400 md:font-medium max-md:flex-col'>
...
//                                     <p className=''>Category:{item.product.name}</p>
//                                 </div>
//                             </div>
