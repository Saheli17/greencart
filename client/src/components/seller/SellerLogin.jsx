...
//                 </div>
//                 <button className="bg-primary hover:bg-primaryDull transition-all text-white w-full py-2 rounded-md cursor-pointer">
//                     Login
//                 </button>
//             </div>
//         </form>
    ...
    return !isSeller && (
        <form onSubmit={onSubmitHandler} className="min-h-screen flex items-center text-sm text-gray-600">
            ...
            >
                ...
                <motion.button
                    whileTap={{ scale: 0.97 }}
                    className="bg-primary hover:bg-primaryDull transition-all text-white w-full py-2 rounded-md cursor-pointer"
                >
                    Login
                </motion.button>
            </motion.div>
